...
const getEnvironmentValue = (name: string, fallback: string): string => process.env[name]?.trim() || fallback;

export const SERVER_CONFIG = {
  DEFAULT_PORT: 4000,
  API_PREFIX: '/api/reconciliation',
  CORS_ORIGIN: getEnvironmentValue('CORS_ORIGIN', 'http://localhost:3000'),
